...
export class Galleres  {
  	constructor(glaf, fun) {  		
        ...
        this.gallery
        this.indexOld2=0
        this.finalLink="256.png"
        var oo

        this.setArr=function(objectBase){
        ...
        this.drag2=function(){                            
            var o=self.gallery.array[self.gallery.index].object;
            var l=self.par.resursData+""+o.id+this.finalLink;            
            self.par.dragPic.start(32, l, o);  
        ...
        this.init=function(){
            ...
            this.array[0].finalLink=this.finalLink
            ...
            this.array[1].finalLink=this.finalLink;
            ...
            this.array[3].heightPic=128;
            this.array[3].width=(128+this.otstup*4)*2;
            this.array[3].height=128*2+this.otstup*3;
