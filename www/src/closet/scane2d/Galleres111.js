...
export class Galleres  {
  	constructor(glaf, fun) {  		
       ...
       /* 
        ...
        this._index = -1;
        this.object=null;
        this.objectBase=mainBig.objectBase;
        this._width=100
        this._height=100
        ...
        this.init=function(){
            ...
            this.array[0].finalLink="256.png";
            ...
            this.array[1].finalLink="256.png";
...
/*
        ...
        this.drag2=function(){                            
            var o=self.gallery.array[self.gallery.index].object;
            var l=self.par.resursData+""+o.id+"/original.png";            
            self.par.dragPic.start(32, l, o);  
        ...
        this.init=function(){
            ...
            this.array[0].y=-this.otstup;
            this.array[0].otstup=this.otstup; 
            this.array[0].finalLink="original.png"
            this.array[0].boolScale=false
            this.array[0].start(a); 
            ...
            this.array[1].boolPositScrol=false
            this.array[1].scrollBarV.alpha=0.5
            this.array[1].finalLink="original.png";
            this.array[1].whPic=128;
            this.array[1].otstup=0;
            this.array[1].intText=1;
            this.array[1].funOver=this.overXZ;
            ...
            this.array[3].whPic=128;
            this.array[3].otstup=this.otstup;
            this.array[3].finalLink="original.png"//"256.png"
            this.array[3].intText=2;
            this.array[3].otstupBlok=0;  
            this.array[3].x=self.widthBig;
            this.array[3].boolScale=false;
    ...
    set index(value) {
        if(this._index!=value){
            this._index = value;
            this.object=null;
            for (var i = 0; i < this.objectBase.array.length; i++) {
                if(i==this._index){
                    this.object=this.objectBase.array[i];
                    break;
                }
            }
